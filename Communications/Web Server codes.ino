      ...
      if (client.available()) {  // if there's bytes to read from the client,
        ...
        if (c == '\n') {  // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<p class=\"par\"> OUTPUT DATA </p>");
            client.println("<p> <span class=\"speed\" style=\"background-color: #198754!important; color:#f8f9fa!important;\"> " + speed + " </span></p>");
        
            //characters from barcode
            //client.println("<p> <span class=\"characters\" style=\"background-color: #198754!important; color:#f8f9fa!important;\"> " + speed + " </span></p>");
